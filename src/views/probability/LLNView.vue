...
<template>
  <ConceptPage slug="lln">
    ...
    <div class="insight">
      ...
      <p>
        "频率趋于概率"怎么严格化？照搬极限定义会翻车——理论上存在把把出 6 的邪门序列，
        "必然收敛"许不出口。伯努利的修正精妙：不许诺必然，许诺<strong>概率</strong>——
        你出精度 ε 和把握要求（比如 99.99%），我答 N：掷够 N 次后，均值落在期望 ±ε 内的
        <strong>概率</strong>超过 99.99%。极限讲的那场 ε-N 攻防原样上演，
        只是"保证达标"降级成"以任意高的把握达标"——对一切实际用途，这就够了。
      </p>
    </div>
    <p>
    ...
    <ul>
      ...
      <li>
        <strong>圣彼得堡悖论的警钟</strong>：掷硬币直到出正面，第 k 次才出就赔 2^k——这游戏期望无穷大，
      ...
      <li>
        ...
        1/√n 尺度上放大看，答案是一条举世通用的曲线——最后一讲，钟形登场。
      </li>
    </ul>
    <div class="insight">
