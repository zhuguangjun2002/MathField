...
<template>
  <ConceptPage slug="residue">
    ...
    <QuizBox
      ...
      hint="回到「三行算尽」那一步：$(z-z_0)^n$ 的原函数写出来是什么？哪个 n 会让这个写法失效？"
      :options="[
    ...
    <QuizBox
      ...
      hint="拿 $\sin z / z^2$ 试一下：分母写着二次方，它就是二阶极点吗？（别忘了 $\sin z = z - z^3/6 + \cdots$。）"
      :options="[
    ...
    <QuizBox
      ...
      hint="包络是 $e^{-\gamma t/2}$，而极点的虚部正是 $-\gamma/2$。虚部变成 0、再变成正数，这个包络长什么样？"
      :options="[
